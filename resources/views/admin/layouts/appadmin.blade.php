...
<body>
            ...
            <nav class="navbar navbar-header navbar-expand-lg" data-background-color="dark2">
                <div class="container-fluid">
                    <div class="collapse" id="search-nav">
                        <div class="user-box">
                            <div class="u-text">
                                <h2 style="color: white; font-weight: 600; margin: 0;" data-aos="fade-right">{{ Auth::user()->nombre ?? 'Administrador' }}</h2>
                            </div>
                        </div>
                    </div>
    ...
    <a href="{{ route('administrador') }}" style="padding: 12px 10px;" class="d-flex align-items-center">
...
<li class="nav-item" data-aos="fade-right" data-aos-delay="300">
    <a href="{{ route('sinstituciones') }}" style="padding: 12px 10px;" class="d-flex align-items-center">
        <i class="fas fa-university" style="font-size: 1.1rem;"></i>
        <p style="font-size: 14px; margin-left: 10px;">Instituciones</p>
    </a>
</li>

<li class="nav-item" data-aos="fade-right" data-aos-delay="300">
    <a href="{{ route('administrador/usuarios') }}" style="padding: 12px 10px;" class="d-flex align-items-center">
        <i class="fas fa-users" style="font-size: 1.1rem;"></i>
        <p style="font-size: 14px; margin-left: 10px;">Usuarios</p>
    </a>
</li>

<li class="nav-item" data-aos="fade-right" data-aos-delay="350">
    <a href="{{ url('coordinador/notificaciones') }}" style="padding: 12px 10px;" class="d-flex align-items-center">
        <i class="fas fa-bell" style="font-size: 1.1rem;"></i>
        <p style="font-size: 14px; margin-left: 10px;">Notificaciones</p>
    </a>
</li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="copyright ml-auto">
                        {{ now()->year }} © Homologaciones uniautonoma <a href="https://www.uniautonoma.edu.co"
                            target="_blank" style="color: #007bff; text-decoration: none;">Uniautónoma</a> v{{ ENV('APP_VERSION', '1.0') }}
                    </div>
                </div>
            </footer>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (!sessionStorage.getItem('welcomeShown')) {
                setTimeout(function() {
                    showNotification('¡Bienvenido al sistema!', 'Explora las nuevas funcionalidades disponibles.', 'info');
            ...
            swal({
                ...
                buttons: {
                    confirm: {
                        ...
                        value: true,
                        visible: true,
                        className: "btn btn-" + (type === 'error' ? 'danger' : type),
                        closeModal: true
                    }
                }
            });
        ...
        window.closePopupNotification = closePopupNotification;
    </script>

...
<head>
    ...
    <!-- Core JS Files - jQuery required for page load -->
 ...
 */
        ...
        :focus {
            outline: 3px solid rgba(4, 1, 214, 0.5);
            outline-offset: 2px;
        }
        ...
        .spinner {
            width: 50px;
            height: 50px;
            border: 4px solid rgba(6, 45, 153, 0.3);
            border-radius: 50%;
            border-top-color: #fff;
            animation: spin 1s ease-in-out infinite;
        }

        /* Fix para enlaces en el menú */
        .nav-item a {
            position: relative;
            transition: all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94);
            color: #0254be !important;
            padding: 12px 15px;
            display: flex;
            align-items: center;
        }
...
<body>
            ...
            <nav class="navbar navbar-header navbar-expand-lg" data-background-color="dark2">
                <div class="container-fluid">
                    <div class="collapse" id="search-nav">
                        <div class="user-box">
                            <div class="u-text">
                                <h2 style="color: white; font-weight: 600; margin: 0;" data-aos="fade-right">
                                    {{ Auth::user()->nombre ?? 'Administrador' }}</h2>
                            </div>
                        </div>
                    </div>
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <li class="nav-item dropdown hidden-caret" data-aos="fade-left">
                            ...
                            <div class="notification-dropdown">
                                ...
                                <div class="notification-list scrollbar-outer">
                ...
                <div class="sidebar-content">
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item" data-aos="fade-right" data-aos-delay="200">
                            <a href="{{ route('administrador') }}" class="d-flex align-items-center">
                                <i class="fas fa-home"></i>
                                <span style="margin-left: 10px;">Inicio</span>
                            </a>
                        </li>
                        <!-- Submenú Instituciones -->
                        <li class="nav-item has-submenu" data-aos="fade-right" data-aos-delay="250">
                            <a href="#" class="d-flex align-items-center submenu-toggle">
                                <i class="fas fa-university"></i>
                                <span style="margin-left: 10px;">Instituciones</span>
                                <i class="fas fa-chevron-down submenu-arrow ml-auto"></i>
                            </a>
                            <ul class="nav submenu" style="display: none; background: #003366;">
                                <li><a href="{{ route('crearinsti') }}" class="d-flex align-items-center nav-link"><i
                                            class="fas fa-plus-circle"></i><span style="margin-left: 10px;">Crear
                                            Institución</span></a></li>
                                <li><a href="{{ route('crearasignatura') }}"
                                        class="d-flex align-items-center nav-link"><i
                                            class="fas fa-chalkboard-teacher"></i><span
                                            style="margin-left: 10px;">Crear Asignatura</span></a></li>
                                <li><a href="{{ route('sinstituciones') }}"
                                        class="d-flex align-items-center nav-link"><i
                                            class="fas fa-list-alt"></i><span style="margin-left: 10px;">Ver
                                            Instituciones</span></a></li>
                            </ul>
                        </li>
                        <!-- Submenú Usuarios -->
                        <li class="nav-item has-submenu" data-aos="fade-right" data-aos-delay="300">
                            <a href="#" class="d-flex align-items-center submenu-toggle">
                            ...
                            <ul class="nav submenu" style="display: none; background: #003366;">
                                <li><a href="{{ route('usuarioscrear') }}"
                                        class="d-flex align-items-center nav-link"><i
                                            class="fas fa-user-plus"></i><span style="margin-left: 10px;">Crear
                                            Usuario</span></a></li>
                                <li><a href="{{ route('administrador/usuarios') }}"
                                        class="d-flex align-items-center nav-link"><i class="fas fa-users"></i><span
                                            style="margin-left: 10px;">Ver Usuarios</span></a></li>
                            </ul>
                        </li>
                        <li class="nav-item" data-aos="fade-right" data-aos-delay="600">
                            <a href="#" onclick="confirmarCerrarSesion()" class="d-flex align-items-center">
    ...
    <!-- Core JS Files - Bottom of page for better performance -->
    ...
    <script>
        ...
        $(document).ready(function() {
            // Initialize AOS with proper parameters
            AOS.init({
                duration: 800,
                easing: 'ease-in-out',
                once: true,
            ...
            // Initialize Select2 with animation
            $('.select2').select2({
            ...
            // Sistema de notificaciones demo (solo mostrar en la primera carga)
            if (!sessionStorage.getItem('welcomeShown')) {
                setTimeout(function() {
                    showNotification('¡Bienvenido al sistema!',
                        'Explora las nuevas funcionalidades disponibles.', 'info');
            ...
            $('.notification-toggle').click(function(e) {
                ...
                $('.notification-count').fadeOut(500);
            });
            ...
            // Highlight active menu item properly
            highlightActiveMenuItem();

            // Set tooltips
            $('[data-toggle="tooltip"]').tooltip();

            // Initialize custom SweetAlert if session has alert messages
            initSweetAlert();

            // Add ripple effect to sidebar toggle buttons
            addRippleEffect();
        ...
        function addRippleEffect() {
            $('.btn-toggle, .sidenav-toggler').on('click', function(e) {
...
function confirmarCerrarSesion() {
    ...
    setTimeout(() => {
        ...
        // Function to initialize SweetAlert based on session
        function initSweetAlert() {
            @if (session('sweet_alert'))
                swal({
                    ...
                    timer: {{ session('sweet_alert.timer') ?? 5000 }},
                    button: "{{ session('sweet_alert.button') ?? 'OK' }}",
                });
            @endif
        }
        ...
        function showNotification(title, message, type) {
            ...
            $('.notification-popup-container').append(`
                <div class="notification-popup notification-${type}" id="popup-${notificationId}">
                    ...
                    <div class="notification-close" onclick="closePopupNotification('popup-${notificationId}')">
                        <i class="fas fa-times"></i>
                    </div>
                </div>
            `);
        ...
        // Submenús animados para menú lateral (Instituciones y Usuarios)
            ...
            submenuToggles.forEach(function(toggle) {
                toggle.addEventListener('click', function(e) {
                    ...
                    if (submenu && submenu.classList.contains('submenu')) {
                        ...
                        document.querySelectorAll('.nav .submenu').forEach(function(other) {
                            if (other !== submenu) {
